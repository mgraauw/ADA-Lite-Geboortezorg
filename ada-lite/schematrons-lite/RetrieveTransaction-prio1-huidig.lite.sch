...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
        ...
        queryBinding="xslt2"
        xml:lang="nl-NL"><!-- == Generated Schematron file for validating ADA Lite prio1_huidig documents == --><!-- == Source: design/specs-full/RetrieveTransaction-prio1-huidig.xml == --><!-- == Generator(s): design/xsl/ada-rtd2ada-schema-simple.xsl; design/xsl/ada-schema-simple2ada-schematron.xsl == -->
