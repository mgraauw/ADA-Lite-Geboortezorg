...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
        ...
        queryBinding="xslt2"
        xml:lang="nl-NL"><!-- == Generated Schematron file for validating ADA Lite prio1_vorig transactions  == --><!-- == Source: RetrieveTransaction-prio1-vorig.xml == --><!-- == Generator(s): ada-rtd2ada-schema-simple.xsl; ada-schema-simple2ada-schematron.xsl == -->
