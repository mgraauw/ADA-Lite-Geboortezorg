...
-->
<!-- == Generated Schematron file for validating ADA Full prio1_vorig documents == --><!-- == Source: design/specs-full/RetrieveTransaction-prio1-vorig.xml == --><!-- == Generator(s): design/xsl/ada-rtd2ada-schema-simple.xsl; design/xsl/ada-schema-simple2ada-schematron.xsl == -->   <ns uri="http://www.w3.org/2001/XMLSchema-instance" prefix="xsi"/>
